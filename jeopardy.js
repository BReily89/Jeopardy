$(document).ready(function () {
    window.alert(`This is Jeopardy with your host Alex Trebek. To play this game You will click on a box with a dollar amount and a pop-up will appear with the question and corresponding answers. You must type in your answer with proper spelling and capitalization. As you progress through the game your score will increase or decrease with correct or incorrect answers. If at the end of the game your points are more than zero. YOU WIN. At least until I figure out how to work the logic to allow 2 players and an option to wager money.`);
    let score = 0;
    ...
    $('.potentPotablesOneHundred').click(function ($event) {
        ...
        if (y === potentPotablesQuestions[0].answer) {
            alert('Correct!');
            score += potentPotablesQuestions[0].points;
            $('.scoreUpdate').html(score);
        }
        else {
            alert('Incorrect');
    ...
    $('.potentPotablesTwoHundred').click(function ($event) {
        ...
        if (y === potentPotablesQuestions[1].answer) {
            alert('Correct!');
            score += potentPotablesQuestions[1].points;
            $('.scoreUpdate').html(score);
        }
        else {
            alert('Incorrect');
    ...
    $('.potentPotablesThreeHundred').click(function ($event) {
        ...
        if (y === potentPotablesQuestions[2].answer) {
            alert('Correct!');
            score += potentPotablesQuestions[2].points;
            $('.scoreUpdate').html(score);
        }
        else {
            alert('Incorrect');
    ...
    $('.potentPotablesFourHundred').click(function ($event) {
        ...
        if (y === potentPotablesQuestions[3].answer) {
            alert('Correct!');
            score += potentPotablesQuestions[3].points;
            $('.scoreUpdate').html(score);
        }
        else {
            alert('Incorrect');
